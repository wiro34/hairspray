...
public class FactoryLoadingExtension implements Extension {
    ...
    public <t> void processAnnotatedType(@Observes ProcessAnnotatedType<t> event) {
        System.out.println("processAnnotatedTypeprocessAnnotatedTypeprocessAnnotatedTypeprocessAnnotatedTypeprocessAnnotatedTypeprocessAnnotatedTypeprocessAnnotatedTypeprocessAnnotatedType");
    ...
    public void afterBeanDiscovery(@Observes AfterBeanDiscovery event, BeanManager bm) {
        System.out.println("afterBeanDiscoveryafterBeanDiscoveryafterBeanDiscoveryafterBeanDiscoveryafterBeanDiscoveryafterBeanDiscoveryafterBeanDiscovery");
